      ...
      try{
         ...
         if (esql.executeQuery(query) == 0) {
            ...
            while(usermenu) {
               ...
               switch (readChoice()){
                  case 1:
                  System.out.println("\nWhat would you like to update the type to?: ");
     ...
     try{
      ...
      while(usermenu) {
         ...
         switch (readChoice()){
            ...
            if(found_id > 0){
               esql.executeQueryAndPrintResult(query);
               System.out.println("\nOrderID found! Deleting old order for new order...");
               ...
               esql.executeUpdate(query);
               System.out.println("Old Order Successfully Deleted!\n");
               UserOrder(esql);
